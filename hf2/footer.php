        ...
        <!--/ END BACK TOP -->
<!-- <?php
// include 'hf2/tour.php';
 ?> -->
        <!-- START JAVASCRIPT SECTION (Load javascripts at bottom to reduce load time) -->
        <!-- START @CORE PLUGINS -->
        <script src="2temp/assets/global/plugins/bower_components/jquery/dist/jquery.min.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/jquery-cookie/jquery.cookie.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/typehead.js/dist/handlebars.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/typehead.js/dist/typeahead.bundle.min.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/jquery-nicescroll/jquery.nicescroll.min.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/jquery.sparkline.min/index.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/jquery-easing-original/jquery.easing.1.3.min.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/ionsound/js/ion.sound.min.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/bootbox/bootbox.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/chartjs/Chart.min.js"></script>
        <!--/ END CORE PLUGINS -->

        <!-- panel inicio grafico    -->
        <?php if ($FpanelInicio) { ?>
        <script src="2temp/assets/global/plugins/bower_components/bootstrap-session-timeout/dist/bootstrap-session-timeout.min.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/chartist/dist/chartist.min.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/waypoints/lib/jquery.waypoints.min.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/counter-up/jquery.counterup.min.js"></script>
        <?php } ?>
        <!-- panel inicio grafico    -->

        <!-- switch I -->
        <?php if($Fswitch){ ?>
        <script src="2temp/assets/global/plugins/bower_components/bootstrap-switch/dist/js/bootstrap-switch.min.js"></script>
        <script src="2temp/assets/global/plugins/bower_components/jquery.inputmask/dist/jquery.inputmask.bundle.min.js"></script>
        <?php } ?>
        <!-- switch F -->
        <!-- tutoriales I -->
        <?php if($Ftutoriales){ ?>
        <script src="2temp/assets/commercial/plugins/cube-portfolio/cubeportfolio/js/jquery.cubeportfolio.min.js"></script>
        <script src="2temp/assets/admin/js/pages/blankon.faq.js"></script>
        <?php } ?>
        <!--/ tutoriales F -->

        <!-- START @PAGE LEVEL SCRIPTS -->
        <script src="2temp/assets/admin/js/apps.js"></script>
        <script src="2temp/assets/admin/js/pages/blankon.dashboard.js"></script>
        <?php if($Finformes){ ?>
        <script src="2temp/assets/admin/js/pages/blankon.chart.chartjs.js"></script>
        <?php } ?>
        <!-- swtich I -->
        <?php if($Fswitch){ ?>
        <script src="2temp/assets/admin/js/pages/blankon.form.advanced.js"></script>
        <?php } ?>
        <!-- swtich F -->
        <!-- grafico panel inicio -->
        <?php if ($FpanelInicio) { ?>
        <script src="2temp/assets/admin/js/pages/blankon.dashboard.realestate.js"></script>
        <?php } ?>
        <!-- grafico panel inicio -->
        <!-- <script src="2temp/assets/admin/js/demo.js"></script> -->
...
$(function () {
  $('textarea.mention-example2').mentionsInput({
    onDataRequest:function (mode, query, callback) {
      $.getJSON('moduloML/preguntas/mentions-masteter/assets/<?php echo $_SESSION['empresa']; ?>.json', function(responseData) {
