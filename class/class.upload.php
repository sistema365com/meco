...
class upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->translation['image_too_narrow']            = 'La imagen es demasiado angosta, minimo 600px de ancho';
        ...
        $this->translation['ratio_too_low']               = 'Error en la relacion de aspecto de la foto';
