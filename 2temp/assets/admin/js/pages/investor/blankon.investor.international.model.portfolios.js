var BlankonInvestorInternationalModelPortfolios = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonInvestorInternationalModelPortfolios.handleAdminReports();
        },
        ...
        handleAdminReports: function () {
            ...
            var tableDom = $('#datatable-current-portfolio');
...
// Call main app init
BlankonInvestorInternationalModelPortfolios.init();