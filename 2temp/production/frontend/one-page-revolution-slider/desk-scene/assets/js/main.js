    ...
    return {
        ...
        handlePreloader: function () {
            setTimeout(function(){
                ...
                BlankonSliderRevolutionDeskScene.handleBanner();
            }, 3000);
        },
            ...
            tpj(document).ready(function() {
                if(tpj("#rev_slider_426_1").revolution == undefined){
                    ...
                    revapi426 = tpj("#rev_slider_426_1").show().revolution({
                        sliderType:"hero",
                        jsFileLocation: BlankonSliderRevolutionDeskScene.handleBaseURL()+"/assets/commercial/plugins/slider-revolution/revolution/js/",
