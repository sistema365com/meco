...
"use strict";
(function(){
    angular.module('blankonApp.widget.overview', [])
        ...
        // MOST BROWSER USED
        // =========================================================================
        .directive('browserChart', function () {
            return {
                restrict: 'A',
                link: function (scope, element) {
        ...
        // SALES CHART
        // =========================================================================
        .directive('marketTodayChart', function () {
            return {
                restrict: 'A',
                link: function (scope,element){
        ...
        .directive('marketAverageChart', function () {
            return {
                restrict: 'A',
                link: function (scope,element){
                    element.sparkline('html',{
        ...
        .directive('marketTotalChart', function () {
            return {
                restrict: 'A',
                link: function (scope,element){
                    element.sparkline('html',{
        ...
        // MARKET STATUS
        // =========================================================================
        .directive('marketStatusChart', function () {
            return {
                restrict: 'A',
                link: function (scope,element){
                    var piedata = [
