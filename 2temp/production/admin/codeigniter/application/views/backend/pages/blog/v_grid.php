...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
    <div class="blog-item rounded shadow">
        <a href="<?php echo base_url($this->config->item('link_url').'/blog/blog-single')?>" class="blog-img"><img src="http://img.djavaui.com/?create=250x170,4888E1?f=ffffff" class="img-responsive full-width" alt="..." /></a>
        <div class="blog-details">
            ...
            <div class="blog-summary">
                ...
                <a href="<?php echo base_url($this->config->item('link_url').'/blog/blog-single')?>" class="btn btn-sm btn-success">Read More</a>
            </div>
        </div>
    </div><!-- /.blog-item -->
</div><!-- col-md-3 -->
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
    <div class="blog-item blog-quote rounded shadow">
        <div class="quote quote-primary">
            <a href="<?php echo base_url($this->config->item('link_url').'/blog/blog-single')?>">
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
    <div class="blog-item rounded shadow">
        <a href="<?php echo base_url($this->config->item('link_url').'/blog/blog-single')?>" class="blog-img"><img src="http://img.djavaui.com/?create=250x170,4888E1?f=ffffff" class="img-responsive" alt="..." /></a>
        <div class="blog-details">
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
    <div class="blog-item rounded shadow">
        <div id="carousel-blog-post" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="http://img.djavaui.com/?create=250x170,4888E1?f=ffffff" class="img-responsive" alt="..." />
        ...
        <div class="blog-details">
            <h4 class="blog-title"><a href="<?php echo base_url($this->config->item('link_url').'/blog/blog-single')?>">This is my Way! Don't stop me</a></h4>
            <ul class="blog-meta">
                <li>By: <a href="http://djavaui.com/" target="_blank">Djava UI</a></li>
                <li>Jun 08, 2014</li>
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
    <div class="blog-item rounded shadow">
        ...
        <div class="blog-details">
            <h4 class="blog-title"><a href="<?php echo base_url($this->config->item('link_url').'/blog/blog-single')?>">New Zealand, Nature Landscapes</a></h4>
            <ul class="blog-meta">
                <li>By: <a href="http://djavaui.com/" target="_blank">Djava UI</a></li>
                <li>Jun 08, 2014</li>
...
<p class="text-center"><img src="<?php echo base_url('assets/global/img/loader/general/2.gif')?>" alt="..."/> Load more post</p>
