...
<div id="sign-wrapper">
    ...
    <!-- Lock screen form -->
    <form class="lock form-horizontal rounded shadow" action="<?php echo site_url($this->config->item('link_url').'/dashboard'); ?>">
        <div class="sign-header">
            <div class="form-group">
                <div class="sign-text">
                    <img data-no-retina src="http://img.djavaui.com/?create=100x100,4888E1?f=ffffff" alt="admin" class="img-circle">
