    ...
    <div class="row">
        <div class="col-sm-3">
            <ul class="nav nav-pills nav-stacked nav-email rounded shadow mb-20">
                <li class="active">
                    <a href="<?php echo base_url($this->config->item('link_url').'/mail/mail-inbox')?>">
                        <i class="fa fa-inbox"></i> Inbox  <span class="label pull-right">7</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url($this->config->item('link_url').'/mail/mail-compose')?>"><i class="fa fa-envelope-o"></i> Send Mail</a>
                </li>
                <li>
                ...
                <div class="panel mail-wrapper rounded shadow">
                    ...
                    <div class="panel-sub-heading inner-all">
                        ...
                        <div class="pull-right">
                            ...
                            <a href="<?php echo base_url($this->config->item('link_url').'/mail/mail-compose')?>" class="btn btn-success btn-sm"><i class="fa fa-reply"></i> Reply</a>
                        </div>
                        <div class="clearfix"></div>
                            ...
                            <ul>
                                <li>
                                    <a class="atch-thumb" href="#" data-toggle="modal" data-target=".bs-example-modal-photo1">
                                        <img src="http://img.djavaui.com/?create=200x110,6880B0?f=ffffff" alt="...">
                                    </a>
