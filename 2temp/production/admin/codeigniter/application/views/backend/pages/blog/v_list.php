...
<div class="blog-item rounded shadow">
    <a href="<?php echo base_url($this->config->item('link_url').'/blog/blog-single')?>" class="blog-img"><img src="http://img.djavaui.com/?create=300x200,4888E1?f=ffffff" class="img-responsive full-width" alt="..." /></a>
...
<div class="blog-item rounded shadow">
    <a href="<?php echo base_url($this->config->item('link_url').'/blog/blog-single')?>" class="blog-img"><img src="http://img.djavaui.com/?create=300x200,4888E1?f=ffffff" class="img-responsive" alt="..." /></a>
    <div class="blog-details">
    ...
    <div id="carousel-blog-post" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <img src="http://img.djavaui.com/?create=300x200,4888E1?f=ffffff" class="img-responsive" alt="..." />
