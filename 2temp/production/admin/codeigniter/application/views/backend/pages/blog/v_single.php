                    ...
                    <div class="item active">
                        <div class="blog-list">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading"><a href="<?php echo base_url($this->config->item('link_url').'/blog/blog-single')?>" title="Lorem ipsum dolor sit">Lorem ipsum dolor sit</a></h4>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading"><a href="<?php echo base_url($this->config->item('link_url').'/blog/blog-single')?>" title="Ut enim ad minim veniam">Ut enim ad minim veniam</a></h4>
                    ...
                    <div class="item">
                        <div class="blog-list">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading"><a href="<?php echo base_url($this->config->item('link_url').'/blog/blog-single')?>" title="Excepteur sint occaecat cupidatat">Excepteur sint occaecat cupidatat</a></h4>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading"><a href="<?php echo base_url($this->config->item('link_url').'/blog/blog-single')?>" title="Sed ut perspiciatis unde">Sed ut perspiciatis unde</a></h4>
