...
class Informes
{
    public function importesPorMesAño($ano=2017)
    {
    ...
    public function visitasPorMesAño($ano=2017)
    {
        $link=Conexion::conectarK();
    ...
    public function topProducto($ano=2017)
    {
        $link=Conexion::conectarK();
    ...
    public function balance($ano=2017)
    {
        $link=Conexion::conectarK();
